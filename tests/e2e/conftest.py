...
@pytest.fixture()
def mock_keyboard_operations(mocker):
    """Mock keyboard operations to avoid system-wide side effects."""
    mocker.patch('keyboard.add_hotkey')
    mocker.patch('keyboard.remove_hotkey')
    mocker.patch('keyboard.press')
    mocker.patch('keyboard.release')
...
@pytest.fixture()
def mock_mouse_operations(mocker):
    """Mock mouse operations to avoid system-wide side effects."""
    mocker.patch('pyautogui.mouseDown')
    mocker.patch('pyautogui.mouseUp')
