...
class MainWindow:
  ...
  def setup_ui(self):
    ...
    ttk.Label(header_frame, text="Nathan's Python Scripts", font=("Helvetica", 16)).pack()
    ...
    self.combobox = ttk.Combobox(selection_frame, textvariable=self.script_type, state="readonly")
  ...
  def setup_default_ui(self):
    ...
    self.default_ui_label = ttk.Label(self.dynamic_content_frame, text="Please select a script from the dropdown above.")
